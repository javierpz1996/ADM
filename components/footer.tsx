            ...
            <nav className="grid grid-cols-2 gap-2">
              {navLinks.map((link) => (
                <Link
                  key={link.label}
                  href={link.href}
                  className="text-white/80 text-sm hover:text-[#a78bfa] transition-colors duration-200"
                >
                  {link.label}
                </Link>
              ))}
            ...
            <div className="flex gap-4">
              {socialLinks.map((link) => (
                <a
                  ...
                  className="text-white/70 hover:text-[#a78bfa] transition-colors duration-200"
                >
