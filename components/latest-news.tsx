...
export function LatestNews() {
  ...
  return (
    <section id="news" className="relative overflow-hidden bg-[#030712] px-6 py-16 md:px-12 lg:px-20">
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-[#896afd]/5 to-transparent" aria-hidden />
      <div className="relative z-10 mx-auto max-w-7xl">
        <h2 className="mb-12 text-4xl font-black uppercase tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-[#896afd] via-[#a78bfa] to-[#896afd] md:text-5xl lg:text-6xl">
          Latest News
        </h2>
        ...
        {hasMore && (
          <div className="mt-12 flex justify-center">
            <button
              ...
              className="border-2 border-[#896afd]/50 bg-transparent px-8 py-3 text-sm font-bold uppercase tracking-widest text-[#a78bfa] transition-all duration-300 hover:border-[#896afd] hover:bg-[#896afd]/10 hover:shadow-[0_0_20px_rgba(137,106,253,0.3)]"
            >
              Load More
            </button>
          </div>
